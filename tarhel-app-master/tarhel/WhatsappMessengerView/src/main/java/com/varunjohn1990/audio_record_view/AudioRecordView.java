...
public class AudioRecordView {
    ...
    public void initView(ViewGroup view) {
        ...
        imgBgChat = view.findViewById(R.id.img_bg_chat);

        Glide.with(view.getContext()).load(view.getContext().getResources().getDrawable(R.drawable.bg_chat_))
    ...
    public void setHintToEditTextMessage(String s) {
        editTextMessage.setHint(s);
    }

    public void showLoading(String loading) {
        editTextMessage.setHint(loading);
        editTextMessage.setEnabled(false);
        progressbar.setVisibility(View.VISIBLE);
    }

    public void makeAudioDisabled(){
        imageViewAudio.setEnabled(false);
    }

    public void makeAudioEnabled(){
        imageViewAudio.setEnabled(true);
    }

    public void hideLoading(String s) {
        editTextMessage.setHint(s);
