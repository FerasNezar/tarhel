...
public class ProfileViewModel extends ViewModel {
    ...
    public void updateUser(Context context, HashMap<String, File> fileHashMap, HashMap<String, String> stringHashMap) {
        apiRequest = ApiRequest.getInstance(context);
        apiRequest.createUploadRequest(Constants.UpdateProfileUrl, context,fileHashMap, stringHashMap, Priority.HIGH, new ApiRequest.ServiceCallback<String>() {
            @Override
            ...
            public void onFail(ANError error) throws JSONException {
                ...
                if (email!=null){
                    Toasty.info(context,email.get(0).toString(), Toasty.LENGTH_SHORT).show();
                }else if (phone!=null){
                    Toasty.info(context,phone.get(0).toString(), Toasty.LENGTH_SHORT).show();
                }else {
