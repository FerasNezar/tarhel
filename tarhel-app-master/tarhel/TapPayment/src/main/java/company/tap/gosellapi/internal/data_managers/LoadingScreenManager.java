...
public class LoadingScreenManager {
     ...
     */
    public void showLoadingScreen(GoSellPaymentActivity activity) {
        this.hostActivity = activity;
        createLoadingScreen();


    }
    public void showLoadingScreen(GoSellCardAddressActivity activity) {
        this.hostActivity = activity;
        createLoadingScreen();
    }

    public void showLoadingScreen(WebPaymentActivity activity) {
        this.hostActivity = activity;
        createLoadingScreen();
